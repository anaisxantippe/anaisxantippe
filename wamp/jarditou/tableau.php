            ...
            <table class="table">
                ...
                <tbody>
                    <tr class="table-warning">
                        <td><img width="100" height="100" src="../img/7.jpg" alt="barbecue Aramis"
                                title="Barbecue Aramis"></td>
                        <td>7</td>
                        <td>Barbecues</td>
                        <td>Aramis</td>
                        <td>110.00€</td>
                    ...
                    <tr>
                        <td><img width="100" height="100" src="../img/8.jpg" alt="barbecue Athos"
                                title="Barbecue Athos"></td>
                        <td>8</td>
                        <td>Barbecues</td>
                        <td>Athos</td>
                        <td>249.99€</td>
                    ...
                    <tr class="table-warning">
                        <td><img width="100" height="100" src="../img/11.jpg" alt="barbecue Clatronic"
                                title="Barbecue Clatronic"></td>
                        <td>11</td>
                        <td>Barbecues</td>
                        <td>Clatronic</td>
                        <td>135.90€</td>
                    ...
                    <tr>
                        <td><img width="100" height="100" src="../img/12.jpg" alt="barbecue Camping"
                                title="Barbecue Camping"></td>
                        <td>12</td>
                        <td>Barbecues</td>
                        <td>Camping</td>
                        <td>88.00€</td>
                    ...
                    <tr class="table-warning">
                        <td><img width="100" height="70" src="../img/13.jpg" alt="brouette Green"
                                title="Brouette Green"></td>
                        <td>13</td>
                        <td>Brouette</td>
                        <td>Green</td>
                        <td>49.00€</td>
