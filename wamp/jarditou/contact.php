...
<body>
    <div class="container-fluid p-2">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="../contact.php">Accueil</a>
                            </li>
                            <li class="nav-item">
        ...
        <form id="formumu" action="/controller/postform.php" method="POST" enctype="multipart/form-data">
            ...
            <input name="email" id="email" type="email" class="form-control" placeholder="dave.loper@afpa.fr"  >
            <br>
            

            <label class="form_col" for="sujet">Sujet* :</label>
            <select id="sujet" name="sujet" class="form-control" size="1">
                <option name="sujet[]" value="" disabled selected>Veuillez sélectionner un sujet</option>
                <option name="sujet[]" value="commandes">Mes commandes</option>
                <option name="sujet[]" value="produit">Question sur un produit</option>
                <option name="sujet[]" value="réclamation">Réclamation</option>
                <option name="sujet[]" value="autres">Autres</option>
            </select><br>
        ...
        <script src="/controller/postform.php"></script>
