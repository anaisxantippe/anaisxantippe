...
$cheminEtNomDefinitif = '../vue/images/jarditou_photos/'.$nouveauNom;
...
if($InsertIsOk2){
    //$message = "Le produit a été rajouté dans la base de données";
    header("Location: ../vue/tableau.php"); // Si le produit a bien été ajouté, il y a une redirection ver le tableau.php
}
else{
...
if (!empty($aErreur)) // Si le tableau n'est pas vide
{
    ...
    header("Location:../vue/produits_ajout.php?".$sUrl); // On affiche les erreurs dans le formulaire formulaire.php
