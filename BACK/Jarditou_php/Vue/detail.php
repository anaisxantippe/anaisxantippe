...
<!-- <a href="/php/produits_modif_script.php?id=<?php echo $r['pro_id']?>" class="btn btn-warning">EDITER</a> -->
    ...
    //     {
        ...
        <!-- Quand on clique sur le bouton modifier on exécute le script du fichier sur lequel on fait un lien et on récupère l'ID avec ?pro_id=<?= $produit->pro_id?> -->
         <a href="../vue/produits_modif.php?pro_id=<?= $produit->pro_id?>" class="btn btn-warning m-0">Modifier</a>
        ...
        <a href="../model/produits_supprimes_script.php?pro_id=<?= $produit->pro_id?>" class="btn btn-danger m-0" onclick="return confirm('Etes-vous certain(e) de vouloir supprimer le produit ?')">Supprimer</a>
        <?php
        // }
    ?>
</div>
