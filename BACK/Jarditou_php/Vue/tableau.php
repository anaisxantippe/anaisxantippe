<?php
include("../vue/entete.php"); // Inclure l'en-tête dans le fichier tableau.php
...
<a href="../vue/produits_ajout.php?pro_id=<?= $produit->pro_id?>" class="btn btn-primary m-0">Ajouter</a>

    <!-- FOOTER -->

<?php
include("../vue/pieddepage.php"); // Inclure le pied de page dans le fichier tableau.php
?>
