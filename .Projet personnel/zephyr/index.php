...
<!-- calling the css -->
	<link rel="stylesheet" href="../assets/style/indexnav.css">
<!-- calling Bootstrap -->
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							<span class="fa fa-tags"></span><span class="link"> Membres</span> <span class="fa fa-caret-down"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#"><span class="fa fa-tag"></span> Fiches</a></li>
							<li><a href="#"><span class="fa fa-tag"></span> Comptabilité</a></li>
						</ul>
					</li>
					<!-- Planning -->
					<li class="dropdown">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
							<span class="fa fa-gears"></span><span class="link"> Administration</span> <span class="fa fa-caret-down"></span></a>
						<ul class="dropdown-menu">
...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -->
	...
	<script src="../assets/scripts/indexnav.js"></script>
